...
export default function Authenticated({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-100 flex flex-col h-screen">
            <nav className="bg-white dark:bg-emerald-950 border-b border-gray-100 dark:border-emerald-950">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-100 dark:text-gray-100 bg-white dark:bg-emerald-950 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {user.name}
