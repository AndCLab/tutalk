...
const MessageInput = ({ conversation = null }) => {
    ...
    return (
        <div className="flex flex-wrap items-center border-t-2 border-gray-300 bg-gray-300 py-3">
            ...
            <button className="p-1 text-gray-500 hover:text-emerald-800 relative">
            ...
            <div className="order-3 xs:order-3 p-2 flex">
                <Popover className="relative">
                    <Popover.Button className="p-1 text-gray-500 hover:text-emerald-800">
                ...
                <button onClick={onLikeClick} className="p-1 text-gray-500 hover:text-emerald-800">
