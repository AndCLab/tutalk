        ...
        <div className="w-full flex items-center gap-2 py-2 px-3 rounded-md bg-emerald-800">
            <div>
                ...
                {!isPreviewable(file.file) && (
                    <div className="flex justify-center items-center w-10 h-10 bg-emerald-900 rounded">
                        <PaperClipIcon className="w-6 text-gray-100" />
                    </div>
                )}
            </div>
            <div className="flex-1 text-gray-300 text-nowrap text-ellipsis overflow-hidden">
