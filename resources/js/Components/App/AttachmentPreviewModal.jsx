            ...
            >
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="h-screen w-screen">
                        ...
                        >
                            <Dialog.Panel className="flex flex-col w-full h-full transform overflow-hidden bg-neutral-900 text-left align-middle shadow-xl transition-all">
                                <button
                                    onClick={close}
                                ...
                                <div className="relative group h-full">
                                    ...
                                    {currentIndex < previewableAttachments.length - 1 && (
                                        <div
                                            onClick={next}
                                            className="absolute opacity-100 text-gray-100 cursor-pointer flex items-center justify-center w-16 h-16 right-4 top-1/2 rouned-full bg-black/50 z-30"
                                        >
